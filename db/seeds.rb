...
User.destroy_all
user1 = User.find_or_create_by(name: 'user1', bio: 'The first user ever created on the Community Link App' , image: 'https://www.fillmurray.com/250/250', password: '123')
user2 = User.find_or_create_by(name: 'user2', bio: 'The second user ever created on the Community Link App' , image: 'https://www.fillmurray.com/200/200', password: '123')
